...
def render_intro(profile: dict[str, Any]) -> str:
  ...
  <style>
    ...
    .mini-tag-string {{ fill: none; stroke: #8b949e; stroke-width: 1.5; stroke-linecap: round; stroke-dasharray: 2 6; opacity: .72; }}
    .mini-tag {{ fill: #111827; stroke: #8b949e; stroke-width: 1.3; }}
    .mini-tag-eyelet {{ fill: #0d1117; stroke: #8b949e; stroke-width: 1.1; }}
    .mini-tag-kicker {{ font: 700 9px ui-monospace, SFMono-Regular, Menlo, Consolas, monospace; letter-spacing: 1.2px; fill: #8b949e; }}
    .mini-tag-text {{ font: 800 14px ui-monospace, SFMono-Regular, Menlo, Consolas, monospace; fill: #f0f6fc; }}
    .mini-tag-accent {{ fill: #79c0ff; opacity: .9; }}
    .mini-tag-stitch {{ fill: none; stroke: #30363d; stroke-width: 1.1; stroke-linecap: round; stroke-dasharray: 1.5 4; opacity: .95; }}
    .mini-tag-charm-ring {{ fill: none; stroke: #f0f6fc; stroke-width: 1.2; opacity: .82; }}
    .mini-tag-charm-star {{ fill: #f6e58d; stroke: #8b949e; stroke-width: 1; stroke-linejoin: round; }}
    .mini-tag-charm-dot {{ fill: #79c0ff; opacity: .92; }}
  ...
  <g transform="translate(508 92) rotate(-6)">
    ...
    <g transform="translate(10 18) rotate(-12)">
      <circle cx="0" cy="0" r="4.5" class="mini-tag-charm-ring"/>
      <path d="M 0 -8 L 2.3 -2.4 L 8.4 -2.1 L 3.6 1.8 L 5.2 7.7 L 0 4.5 L -5.2 7.7 L -3.6 1.8 L -8.4 -2.1 L -2.3 -2.4 Z" class="mini-tag-charm-star"/>
      <circle cx="8.8" cy="-5.8" r="1.6" class="mini-tag-charm-dot"/>
    </g>
    <path d="M 20 40 L 136 40 L 150 60 L 136 80 L 20 80 Q 8 80 8 60 Q 8 40 20 40 Z" class="mini-tag"/>
    <circle cx="24" cy="60" r="5.5" class="mini-tag-eyelet"/>
    <circle cx="24" cy="60" r="2.2" class="bg"/>
...
def render_trail(profile: dict[str, Any]) -> str:
  ...
  <style>
    ...
    .tag-clip {{ fill: none; stroke: #c9d1d9; stroke-width: 1.5; stroke-linecap: round; stroke-linejoin: round; opacity: .88; }}
  ...
  <g transform="translate(968 20) rotate(-4)">
    <ellipse cx="20" cy="-4" rx="10" ry="6" class="tag-ring-shadow"/>
    <ellipse cx="20" cy="-4" rx="8" ry="4.8" class="tag-ring"/>
